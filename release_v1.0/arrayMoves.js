...
Array.prototype.magicWhoosh = function () {
    ...
    for (let row = 0; row < this.length; row++) {
        for (let col = 0; col < this[row].length; col++) {
            ...
            if (this[row][col] === targetPoint) {
                console.info("Bingo! You've hit the target.");
    ...
    if(emptyIndices.length === 0) {
        console.info("Cannot move in the direction. No empty indices found!");
        return;
    }
